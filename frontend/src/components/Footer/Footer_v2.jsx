import { AiFillFacebook, AiOutlineInstagram, AiFillGithub, AiOutlineMail, AiOutlinePhone, AiOutlineEnvironment, AiOutlineClockCircle } from "react-icons/ai";
                        ...
                        <div className = 'footer-column'>
                            ...
                            <div className = 'contact-info'>
                                <div className = 'contact-item'>
                                    ...
                                    <span>Tamazula 522, José Campillo Sáenz, Gómez Palacio, Dgo. 35079</span>
                                </div>
            ...
            <div className = 'footer-bottom'>
                <div className = 'container'>
                    <div className = 'footer-bottom-content'>
                        <p className = 'copyright'>@ {year} 2025 Ferretería Abrinal. Todos los derechos reservados.</p>
